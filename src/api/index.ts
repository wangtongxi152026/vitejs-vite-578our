...
export const getDetaixl = async () => {
  let result = await fetch("http://iwencai.com/customized/chart/get-robot-data", {
    headers: {
      ...
      Cookie:
        "ta_random_userid=10bzg5cqnm; other_uid=Ths_iwencai_Xuangu_aupv6xc02zy1zxo7jkzil9rge2dg1zji; user=%3D; userid=564154360; u_name=mx_564154360; escapename=mx_564154360; ticket=65a4c5df6ec7b05a27197b812e293b8e; user_status=0; utk=de1172c3a7071561de889eeee794db49; v=A1yYzgN9Ui8d0iZ6k8xq8sqKLXEL1WTMgjoVGzZCa4sqo_KvXuXQj9KJ5DCF",
      "hexin-v": "A1yYzgN9Ui8d0iZ6k8xq8sqKLXEL1WTMgjoVGzZCa4sqo_KvXuXQj9KJ5DCF",
      pragma: "no-cache",
    },
    referrer:
      "http://iwencai.com/unifiedwap/result?w=%E6%9C%BA%E6%9E%84%E6%8C%81%E8%82%A1%E5%8D%A0%E6%B5%81%E9%80%9A%E8%82%A1%E6%AF%94%E4%BE%8B%3E50%25&querytype=stock&addSign=1648981377452",
    referrerPolicy: "strict-origin-when-cross-origin",
    body: JSON.stringify({
      question: "非st",
      // "非st，非科创板，非退市，非停牌，流通市值大于5亿元，非同花顺，近1个月有>=1次的减持公告取反，总市值小于30亿元股价小于6元市盈率为正小于36倍日换手率大于2%",
      page: 1,
      perpage: 999,
